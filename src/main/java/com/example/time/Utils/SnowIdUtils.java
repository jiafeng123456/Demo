 ...
 *@description:雪花算法
 *@author jiafeng
 *@date 2020/8/12 0012 14:21
 */
public class SnowIdUtils {
    private static Logger log = LoggerFactory.getLogger(SnowIdUtils.class);
    /**
     * 私有的 静态内部类
     */
...
//    }
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 10000 ; i++){
            long snowID = SnowIdUtils.uniqueLong();
            log.info("生成的雪花ID{}",snowID);
        }
        log.info("生成10000条雪花ID,总用时={}", System.currentTimeMillis() - start);
    }
}
